...
mixin _$MangaInfo {
  ...
  int get chaptersCount => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      tags: null == tags
          ...
          : tags // ignore: cast_nullable_to_non_nullable
              as List<String>,
      chaptersCount: null == chaptersCount
      ...
      finishedAt: freezed == finishedAt
          ...
          : finishedAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      lastChapterDate: freezed == lastChapterDate
          ? _value.lastChapterDate
          : lastChapterDate // ignore: cast_nullable_to_non_nullable
              as DateTime?,
    ) as $Val);
  }
}
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.lastChapterDate, lastChapterDate) ||
...
abstract class _MangaInfo implements MangaInfo {
  factory _MangaInfo(
      ...
      required final List<String> tags,
      required final int chaptersCount,
      required final List<String> imagesUrls,
      final int? myAnimeListId,
      final int? anilistId,
      final double? averageScore,
